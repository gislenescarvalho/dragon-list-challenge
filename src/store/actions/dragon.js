  ...
  return dispatch => {
    DragonAPI.addDragon(newDragon)
      ...
      .catch(() => {
        dispatch(
          addDragonFail(
            "An unexpected error occurred - it's not possible to add a new item!"
          )
        )
      })
  }
  ...
  return dispatch => {
    DragonAPI.editDragon(dragonDetails)
      ...
      .catch(() => {
        dispatch(
          saveDragonFail(
            "An unexpected error occurred - it's not possible to save this item!"
          )
        )
      })
  }
  ...
  return dispatch => {
    ...
    DragonAPI.deleteDragonById(dragonId)
      ...
      .catch(() => {
        dispatch(
          deleteDragonFail(
            "An unexpected error occurred - it's not possible to delete this item!"
          )
        )
      })
  }
